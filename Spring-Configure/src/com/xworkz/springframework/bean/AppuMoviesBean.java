	...
	public class AppuMoviesBean {
		...
		public String toString() {
			return "AppuMoviesBean [firstMovie=" + firstMovie + ", firstMovieHeroinName=" + firstMovieHeroinName
					+ ", firstMovieDirector=" + firstMovieDirector + ", firstMovieMusicDirector="
					+ firstMovieMusicDirector + ", secondMovie=" + secondMovie + ", secondMovieHeroinName="
					+ secondMovieHeroinName + ", secondMovieDirector=" + secondMovieDirector
					+ ", secondMovieMusicDirector=" + secondMovieMusicDirector + ", thirdMovie=" + thirdMovie
					+ ", thirdMovieHeroinName=" + thirdMovieHeroinName + ", thirdMovieDirector=" + thirdMovieDirector
					+ ", thirdMovieMusicDirector=" + thirdMovieMusicDirector + ", lastMovie=" + lastMovie
					+ ", lastMovieHeroinName=" + lastMovieHeroinName + ", lastMovieDirector=" + lastMovieDirector
					+ ", lastMovieMusicDirector=" + lastMovieMusicDirector + ", totalMovies=" + totalMovies + "]";
		}
