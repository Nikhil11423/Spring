...
public class AvengerStreet {
	...
	public String toString() {
		return "AvengerStreet [company=" + company + ", engineCC=" + engineCC + ", milege=" + milege + ", power="
				+ power + ", price=" + price + ", discType=" + discType + ", fuelType=" + fuelType
				+ ", fuelTankCpacity=" + fuelTankCpacity + ", onRoadPrice=" + onRoadPrice + ", seatHeight=" + seatHeight
				+ ", curbWeight=" + curbWeight + ", overallLength=" + overallLength + ", overallwidth=" + overallwidth
