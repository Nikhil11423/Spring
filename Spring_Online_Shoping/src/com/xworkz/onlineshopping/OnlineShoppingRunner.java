...
public class OnlineShoppingRunner {
	...
	//OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "Cipla", 100.0, "Medicine", 12, "G-pay", "12 percent", 12);
	//OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "Corocin", 2300.0, "Medicine", 12, "G-pay", "12 percent", 12);
	//OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "altretamine", 299.0, "Medicine", 12, "P-pay", "12 percent", 12);
	//OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "Astelin", 34.0, "Medicine", 12, "paytem", "12 percent", 12);
	//OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "Dolo", 345.0, "Medicine", 12, "cash", "12 percent", 12);
	//OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "Metformin", 100.0, "Medicine", 12, "Amazon-pay", "12 percent", 12);
	//OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "Omeprazole", 500.0, "Medicine", 12, "G-pay", "12 percent", 12);
	...
	//OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "Masala puri", 60.0, "Food", 4, "G-pay", "5 percent", 8);
	OnlineShoppingDTO shopping = new OnlineShoppingDTO(0, "Vegitable", 50.0, "Food", 4, "G-pay", "5 percent", 8);
