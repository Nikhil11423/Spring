...
@NamedQueries({
	@NamedQuery(name = "StudentEntity.getStudentByName",query = "GET from StudentEntity where firstname=:INPUTNAME or middlename=:INPUTNAME or lastname=:INPUTNAME or email=:INPUTNAME" ),
